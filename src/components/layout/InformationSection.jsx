...
const InformationSection = () => {
  return (
    <section className="mt-24 grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 mx-auto text-center gap-8">
        <div className="px-4">
          <i className="fa-solid fa-truck-fast text-4xl text-green-400"></i>
          <p className="text-xl text-gray-500 font-semibold mt-4">
            Envio GRATIS dentro de cordoba capital para compras mayores a
            $20,000. Para compras menores el costo de envio sera de $1,000
          </p>
        </div>
        <div>
